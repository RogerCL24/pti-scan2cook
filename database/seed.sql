...
VALUES
('Irene López', 'irene@scan2cook.com
', 'hashedpassword1'),
('Roger García', 'roger@scan2cook.com
', 'hashedpassword2');

-- Productos iniciales
INSERT INTO products (user_id, name, quantity, category, expiration_date)
VALUES
(1, 'Arroz', 2, 'Cereales', '2025-12-01'),
(1, 'Tomate triturado', 3, 'Conservas', '2026-01-15'),
(2, 'Pasta', 1, 'Cereales', '2025-09-10');
