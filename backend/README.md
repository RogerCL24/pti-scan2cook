...
curl "http://localhost:3000/recipes/suggest?ingredients=chicken,rice&number=5"

# Búsqueda avanzada
curl "http://localhost:3000/recipes/search?query=pasta&cuisine=italian"

# Obtener info de receta
curl "http://localhost:3000/recipes/649985"

# Recetas aleatorias
curl "http://localhost:3000/recipes/random?number=3&tags=vegetarian"
```
